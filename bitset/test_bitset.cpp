...
TestResult TestNonConstIterator()
{
	...
	Bitset<8, unsigned char>::NonCIterator it0(&charBt,0);
	REQUIRE(it0 == charBt.Begin());
	REQUIRE(*it0 == true);
	++it0;
	REQUIRE(it0 != charBt.Begin());	
	
	charBt.SetBit(7);
	Bitset<8, unsigned char>::NonCIterator it1(&charBt, 7);
	...
	*it2 = 0;
	...
	Bitset<35, unsigned int> ::NonCIterator it3(intBt.Begin());
	Bitset<35, unsigned int> ::NonCIterator it4(&intBt, 0);
	REQUIRE(it4 == it3);
	++it4;
	REQUIRE(it4 != it3);
	++it3;
...
TestResult TestConstIterator()
{
	...
	Bitset<8, unsigned char>::CIterator it0(&charBt,0);
	REQUIRE(it0 == charBt.CBegin());
	REQUIRE(*it0 == true);
	
	charBt.SetBit(7);
	Bitset<8, unsigned char>::CIterator it1(&charBt, 7);
	Bitset<8, unsigned char>::CIterator it2(charBt.CEnd());
	REQUIRE(it1 != it2); 
	
	Bitset<35, unsigned int> intBt;
	intBt.SetBit(0);

	Bitset<35, unsigned int> ::CIterator it3(intBt.CBegin());
	Bitset<35, unsigned int> ::CIterator it4(&intBt, 0);
	REQUIRE(it4 == it3);
	
	intBt.SetBit(34);
	Bitset<35, unsigned int> ::CIterator it6(intBt.CEnd());
	Bitset<35, unsigned int> ::CIterator it7(&intBt, 34);
	REQUIRE(it6 != it7); 

	//make sure cant compile:
	//*it6 = true;
	//++it6;
	//--it6;
