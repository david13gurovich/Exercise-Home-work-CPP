...
public:
    ...
    {        
    public:
        explicit BasicIterator(Bitset *const bitSet, size_t index);
        explicit BasicIterator(const Bitset *const bitSet, size_t index);
        ~BasicIterator() {}
    ...
    private:
        const Bitset *const m_bitSetConst;
        Bitset *m_bitSetNonConst;
        size_t m_index;
    };
...
private:
    ...
    public:
        BitProxy(Bitset *bitset, size_t index);
...
template <size_t N, class STORAGE>
template <class T>
Bitset<N, STORAGE>::BasicIterator<T>::BasicIterator(Bitset<N, STORAGE> *const bitSet, size_t index)
: m_bitSet(bitSet), m_index(index)
{}

template <size_t N, class STORAGE>
template <class T>
Bitset<N, STORAGE>::BasicIterator<T>::BasicIterator(const Bitset<N, STORAGE> *const bitSet, size_t index)
: m_bitSet(bitSet), m_index(index)
{}

template <size_t N, class STORAGE>
typename Bitset<N, STORAGE>::CIterator Bitset<N, STORAGE>::CBegin() 
{
    return (CIterator(this ,0));
}

template <size_t N, class STORAGE>
typename Bitset<N, STORAGE>::CIterator Bitset<N, STORAGE>::CEnd()
{
